...
<section class="room-details container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
    ...
    >
        ...
        <button @click="prev" class="absolute left-3 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full">❮</button>
        <button @click="next" class="absolute right-3 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 rounded-full">❯</button>
